...
mod tests {
    ...
    use crate::{CmpOP, ExpressEnum, LogicOP};

    use super::{cmp_is_true, Condition, LogicExpress, RustSymbol, ValueGet};

    type CompareExpress<T> = crate::CompareExpress<T, RustSymbol>;
